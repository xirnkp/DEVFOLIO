...
const Education: React.FC<EducationProps> = ({ educationHistory }) => {
  ...
  return (
    <motion.div
      id='education'
      ref={sectionRef}
      className="mb-[40vh] space-y-12 mt-20 mb-20 pl-8 px-4 sm:px-8 md:px-16"
      initial={{ opacity: 0, y: 20 }}
      animate={isVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
      transition={{ duration: 0.5 }}
    >
      <h2 className="mb-[10vh] text-5xl sm:text-6xl lg:text-7xl font-bold text-blue-500 mb-6 text-center lg:text-left">Education</h2>
        ...
        <div className="flex-1">
          {educationHistory.map((edu, index) => (
            ...
            >
              ...
              <p className="text-gray-400 text-xl sm:text-2xl">{edu.period} | {edu.location}</p>
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: '0px 0px 12px rgba(79, 163, 255, 0.8), 0px 0px 20px rgba(79, 163, 255, 0.6)', 
                }}
              ></div>
            </motion.div>
          ))}
